...
<li class="fieldcontain">
    <span id="index-label" class="property-label"><g:message code="individual.individualID.label"
                                                             default="Individual ID"/></span>
...
%{-- Stock ID --}%
<li class="fieldcontain">
    <span id="stockID-label" class="property-label"><g:message code="individual.stockID.label"
                                                               default="Stock ID"/></span>
    <g:if test="${individualInstance?.stock}">
        <span class="property-value" aria-labelledby="stockID-label"><g:link controller="stock" action="show"
...
%{-- Stock Name --}%
<li class="fieldcontain">
    <span id="stockName-label" class="property-label"><g:message code="individual.stockID.label"
                                                                 default="Stock Name"/></span>
    <g:if test="${individualInstance?.stock}">
        <span class="property-value" aria-labelledby="stockName-label"><g:link controller="stock" action="show"
                                                                               id="${individualInstance.stock?.id}">${individualInstance.stock.stockName}</g:link></span>
    </g:if>
    <g:else>
...
<li class="fieldcontain">
    <span id="line-label" class="property-label"><g:message code="stock.line.label"
                                                            default="Stock Line"/></span>
    <g:if test="${individualInstance?.stock?.line}">
        <span class="property-value" aria-labelledby="line-label"><g:link controller="line" action="show"
                                                                          id="${individualInstance.stock.line.id}">${individualInstance.stock.line.name}</g:link></span>
    </g:if>
    <g:else>
...
%{-- Fish Sex --}%
<li class="fieldcontain">
    <span id="sex-label" class="property-label"><g:message code="individual.fishSex.label"
                                                           default="Fish Sex"/></span>
...
%{-- Soma Location --}%
<li class="fieldcontain">
    <span id="fishLocation-label" class="property-label"><g:message code="individual.somaLocation.label"
                                                                    default="Soma Location"/></span>
    <g:if test="${individualInstance?.somaLocation}">
        <span class="property-value" aria-labelledby="fishLocation-label"><g:fieldValue
                bean="${individualInstance}" field="somaLocation"/></span>
    </g:if>
    <g:else>
...
%{-- Finclip Location --}%
<li class="fieldcontain">
    <span id="fishLocation-label" class="property-label"><g:message code="individual.finclipLocation.label"
                                                                    default="Finclip Location"/></span>
    <g:if test="${individualInstance?.finclipLocation}">
        <span class="property-value" aria-labelledby="fishLocation-label"><g:fieldValue
                bean="${individualInstance}" field="finclipLocation"/></span>
    </g:if>
    <g:else>
        <span class="property-value" aria-labelledby="fishLocation-label">----</span>
    </g:else>
...
%{-- Finclip Location --}%
<li class="fieldcontain">
    <span id="fishLocation-label" class="property-label"><g:message code="individual.dnaLocation.label"
                                                                    default="DNA Location"/></span>
    <g:if test="${individualInstance?.dnaLocation}">
        <span class="property-value" aria-labelledby="fishLocation-label"><g:fieldValue
                bean="${individualInstance}" field="dnaLocation"/></span>
    </g:if>
    <g:else>
        <span class="property-value" aria-labelledby="fishLocation-label">----</span>
    </g:else>
...
%{-- ID Status --}%
<li class="fieldcontain">
    <span id="fishLocation-label" class="property-label"><g:message code="individual.idstatus.label"
                                                                    default="ID Status"/></span>
    <g:if test="${individualInstance?.idStatus}">
        <span class="property-value" aria-labelledby="fishLocation-label"><g:fieldValue
                bean="${individualInstance}" field="idStatus"/></span>
    </g:if>
    <g:else>
        <span class="property-value" aria-labelledby="idStatusLocation-label">----</span>
    </g:else>
</li>
...
<g:form>
    <fieldset class="buttons">
        ...
        <g:link class="ui-icon-print" action="printPdf" id="${individualInstance?.id}"><g:message
