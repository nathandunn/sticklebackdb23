...
<div class="fieldcontain ${hasErrors(bean: individualInstance, field: 'fertilization', 'error')} ">
	...
	<g:datePicker name="fertilization" precision="day"  value="${individualInstance?.fertilization}" default="none" noSelection="['': '']" />
</div>
...
<div class="fieldcontain ${hasErrors(bean: individualInstance, field: 'maternal', 'error')} required">
	...
	<g:select id="maternal" name="maternal.id" from="${edu.uoregon.sticklebackdb.Individual.list()}" optionKey="id" required="" value="${individualInstance?.maternal?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: individualInstance, field: 'paternal', 'error')} required">
	...
	<g:select id="paternal" name="paternal.id" from="${edu.uoregon.sticklebackdb.Individual.list()}" optionKey="id" required="" value="${individualInstance?.paternal?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: individualInstance, field: 'stock', 'error')} ">
	...
	<g:select id="stock" name="stock.id" from="${edu.uoregon.sticklebackdb.Stock.list()}" optionKey="id" value="${individualInstance?.stock?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: individualInstance, field: 'stockDate', 'error')} ">
	...
	<g:datePicker name="stockDate" precision="day"  value="${individualInstance?.stockDate}" default="none" noSelection="['': '']" />
</div>
...
<div class="fieldcontain ${hasErrors(bean: individualInstance, field: 'stockIndividualDate', 'error')} ">
	...
	<g:datePicker name="stockIndividualDate" precision="day"  value="${individualInstance?.stockIndividualDate}" default="none" noSelection="['': '']" />
</div>
