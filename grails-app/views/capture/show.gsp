...
<html>
	...
	<body>
		<a href="#show-capture" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-capture" class="content scaffold-show" role="main">
			...
			<ol class="property-list capture">
				...
				<li class="fieldcontain">
					<span id="captureDate-label" class="property-label"><g:message code="capture.captureDate.label" default="Capture Date" /></span>
					
						<span class="property-value" aria-labelledby="captureDate-label"><g:formatDate date="${captureInstance?.captureDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="comment-label" class="property-label"><g:message code="capture.comment.label" default="Comment" /></span>
					
						<span class="property-value" aria-labelledby="comment-label"><g:fieldValue bean="${captureInstance}" field="comment"/></span>
			...
			<g:form url="[resource:captureInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${captureInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
