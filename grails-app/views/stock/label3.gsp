...
<div id="label">
    Stock Name: ${stockInstance.labelStockName}
    <br/>

    <div id="number">${stockInstance.stockIDLabel}</div>
    %{--${stockInstance.fertilizationDate}--}%
    Fert: <g:formatDate date="${stockInstance.fertilizationDate}" type="date" dateStyle="long"/>
    <br/>

    <div id="comment">
        ${stockInstance.labelComments}
    </div>
</div>
