...
<script type="text/javascript">
    ...
    %{--d3.json("http://localhost:8080/sticklebackdb/stock/lineage?stockID=${params.stockID}", function(json) {--}%
    d3.json("${createLink(controller: 'stock',action: 'lineage','params':[stockID:params.stockID])}", function (json) {
        root = json;
        root.x0 = height / 2;
        root.y0 = width / 2;
