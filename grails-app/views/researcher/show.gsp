...
<div id="show-researcher" class="content scaffold-show" role="main">
    ...
    <ol class="property-list researcher">
        ...
        <li class="fieldcontain">
            <span id="username-label" class="property-label"><g:message code="researcher.username.label"
                                                                        default="Username"/></span>

            <span class="property-value" aria-labelledby="username-label"><g:fieldValue bean="${researcherInstance}"
                                                                                        field="username"/></span>
        ...
        <li class="fieldcontain">
            ...
            <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${researcherInstance}"
                                                                                    field="name"/></span>

        </li>

        <li class="fieldcontain">
            <span id="roles-label" class="property-label"><g:message code="researcher.roles.label"
                                                                     default="Roles"/></span>
    ...
    <g:form url="[resource: researcherInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${researcherInstance}"><g:message
